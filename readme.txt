...
Tags: sidebar, comment, Facebook, Twitter, github, weibo, 人人网, 开心网, 新浪微博, 腾讯微博, 微博连接, socila media connect
...
修复新浪微博绑定错误
= 2.0.4 =
修复后台文章发布时在IE7下无法使用的问题，增加评论时直接刷新授权功能
= 2.0.3 =
修复天涯微博授权容易失败问题，修复部分在自定义appkey下部分网站无法绑定的问题
= 2.0.2 =
新增支持同步到人人网、facebook、开心网，修复facebook绑定错误，文章同步中一bug
= 2.0.1 =
修复一处根证书验证失败的错误
= 2.0.0 =
v2版本发布
= 1.7.4 =
修正和wordpress 3.3的兼容性问题
= 1.7.3 =
去除follow5文件。
= 1.7.2 =
加入黑名单功能
